...
Handlers for Herald, LadderEncoder, Till reconcile, Lexicon builder, Kiln GPU jobs: they receive `run_id` and treat it as the idempotency key. See [queues-delivery](../foundations/queues-delivery.md) (id: queues-delivery).
...
- [Batching tokens onto scarce GPUs](./llm-serving.md) (id: llm-serving)
