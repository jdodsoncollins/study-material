...
- Grading the assistant's last sentence (`Refund issued!`) instead of the `refunds` table. See [outcome versus transcript](../outcome-vs-transcript/lesson.md) (id: outcome-vs-transcript).
